...
class _QRScannerScreenState extends State<QRScannerScreen>
  ...
  Widget _buildScannerView() {
    ...
    return Stack(
      children: [
        // Camera preview placeholder (actual implementation would use mobile_scanner)
        Container(
          ...
          children: [
            Container(
              ...
              child: const Icon(
                ...
                .shimmer(duration: 2000.ms, color: AppTheme.primaryGreen.withValues(alpha: 0.3)),
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'vless://...  or  vmess://...  or  trojan://...  or  ss://...',
                hintStyle: TextStyle(
    ...
    return [
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
            border: Border(
              ...
              left: BorderSide(color: AppTheme.primaryGreen, width: cornerWidth),
            ),
          ),
        ),
      ),
      ...
      Positioned(
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
            border: Border(
              top: BorderSide(color: AppTheme.primaryGreen, width: cornerWidth),
              right: BorderSide(color: AppTheme.primaryGreen, width: cornerWidth),
            ),
          ),
        ),
      ),
      ...
      Positioned(
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
            border: Border(
              bottom: BorderSide(color: AppTheme.primaryGreen, width: cornerWidth),
              left: BorderSide(color: AppTheme.primaryGreen, width: cornerWidth),
            ),
          ),
        ),
