...
| TLS compatibility | Removed the legacy `allowInsecure` field emitted by the older parser. Xray Core 26 rejects this key even when it is `false`; normal certificate verification remains enabled. |
